...
export VLLM_ATTENTION_BACKEND=XFORMERS
export WANDB_API_KEY=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
...
ACTOR_MODEL_PATH=xxxxxxxxxxxxxx/Qwen2.5-3B-instruct  # your model path here
REWARD_MANAGER=qa
ROLLOUT_N=5
SEARCH_URL=xxxxxxxxxxxx  # your host search url here
...
TEST_FREQ=1
TOTAL_EPOCHS=3
WANDB_API_KEY=xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx  # your wandb api key here
SAVE_PATH=xxxxxxxxxxxxxxxxxxxxxxx  # your save path here

TRAIN_DATA_PATH=xxxxxxxxxxxxxxxxx/hotpotqa/train.parquet  # your train data path here
DEV_DATA_PATH=xxxxxxxxxxxxxxxxx/hotpotqa/dev.parquet  # your dev data path here
